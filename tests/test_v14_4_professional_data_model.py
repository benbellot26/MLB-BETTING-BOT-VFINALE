...
class V144ProfessionalDataModelTests(unittest.TestCase):
    ...
    def test_certification_can_authorize_only_one_market(self):
        ...
        primary={"n":120,"mean_clv":.7,"positive_rate":.56,"mean_clv_ci95_lower":.1,"mean_clv_ci95_upper":.9,"benchmark":"PINNACLE_NO_VIG","inference_method":"paired nonparametric bootstrap mean","bootstrap_reps":5000}
        execution={"n":80,"mean_clv":.3,"positive_rate":.55,"mean_clv_ci95_lower":.05,"mean_clv_ci95_upper":.5,"inference_method":"paired nonparametric bootstrap mean","bootstrap_reps":5000}
        paper={"schema":"pulsar-v14-paper-bet-performance-v8","model_generation":MODEL_GENERATION,"probability_policy_id":PROBABILITY_POLICY_ID,"generated_at":FRESH,"certification_entry_phase":"FINAL","certification_run_trigger":"SCHEDULED_FINAL","primary_clv_benchmark":"PINNACLE_NO_VIG","legacy_consensus_certification_clv_can_certify":False,"by_market":{"ML":{"latest_certified_close_at":FRESH,"latest_primary_close_at":FRESH,"latest_execution_close_at":FRESH,"certification_clv":primary,"execution_clv":execution}}}
