...
NATIVE_MODULES=("acquisition.py","certification.py","context_overlay.py","decision.py","discord.py","distribution.py","distribution_tuning.py","market_edge.py","market_lines.py","mlb_inputs.py","model.py","native_candidate.py","native_payload.py","parity_gate.py","park.py","phase.py","pipeline.py","probability_calibration.py","production_runtime.py","residual_challenger.py","run_stack.py","sharp_market.py","starter_fallback.py","starter_integrity.py","structural.py","tracking.py","uncertainty.py")
