...
NATIVE_MODULES=("acquisition.py","context_overlay.py","discord.py","distribution.py","market_edge.py","market_lines.py","mlb_inputs.py","model.py","native_candidate.py","native_payload.py","parity_gate.py","park.py","phase.py","pipeline.py","production_runtime.py","run_stack.py","starter_fallback.py","starter_integrity.py","structural.py","tracking.py")
