...
def _paper_payload(analyzed_at=ANALYZED_AT,event_time=GAME_DATE,phase="FINAL"):
    ...
    return {"model_generation":MODEL_GENERATION,"target_date":"2026-08-25","analyzed_at":analyzed_at,"results":[{"game_pk":"123","model_generation":MODEL_GENERATION,"odds_event_id":"odds-123","game_date":GAME_DATE,"analyzed_at":analyzed_at,"phase":phase,"home":"Home","away":"Away","canonical_lines":{"TOTAL":8.5},"starter_fallback":{"degraded":False},"market_snapshot":{"freshness_verified":True,"commence_time":event_time,"markets":{"ML":{"bookmaker":"pinnacle"}}},"execution_market":{"freshness_verified":True,"selections":{"home_ml":{"price":2.00,"bookmaker":"pinnacle"}}},"sharp_market":{"freshness_verified":True,"selections":{"home_ml":sharp_row}},"v14_prediction":{"model_generation":MODEL_GENERATION,"probability_policy_id":PROBABILITY_POLICY_ID,"phase":phase,"calibration":{"probability_policy_id":PROBABILITY_POLICY_ID},"probabilities":{"home_ml":.60},"raw_probabilities":{"home_ml":.61}},"decision":{"candidates":[candidate]}}]}
