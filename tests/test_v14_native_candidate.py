...
class V14NativeCandidateTests(unittest.TestCase):
    def test_candidate_is_native_non_publishing(self):
        ...
        self.assertEqual(result["training_features"]["schema"],"pulsar-v14-training-features-v7"); self.assertEqual(result["training_features"]["capture_mode"],"PROSPECTIVE_LIVE_SNAPSHOT"); self.assertTrue(result["training_features"]["pit_source_contract"]["live_pregame_safe"])
