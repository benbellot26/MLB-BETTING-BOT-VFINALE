...
class StatcastPitBackfillTests(unittest.TestCase):
    def test_complete_provider_query_contract_is_explicit(self):
        ...
        self.assertEqual(params["type"],"details")
        self.assertEqual(params["player_type"],"pitcher")
        self.assertEqual(params["group_by"],"name")
        self.assertEqual(params["hfPT"],"")
        self.assertEqual(params["hfGT"],"R|")
        self.assertEqual(params["hfSea"],"2026|")
        self.assertEqual(params["game_date_gt"],"2026-04-01")
        self.assertEqual(params["game_date_lt"],"2026-04-03")
    ...
    def test_only_prior_pitch_rows_enter_cutoff_snapshot_and_pitch_splits(self):
        ...
        self.assertEqual(out["schema"],"pulsar-v14-statcast-pit-backfill-v3")
