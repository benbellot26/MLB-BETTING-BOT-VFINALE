...
def build():
    ...
    return {"schema":"v13-run-mean-prior-v1","active":active,"historical_candidate_active":bool(historical_passes),"phase_scope":"FINAL",
            ...
            "activation_rule":"historical chronological validation/test must pass AND >=20 current-generation genuine FINAL V13 transfer games, evaluated from an independent pre-prior baseline, must pass RMSE/NB-NLL with MAE regression <=0.01",
