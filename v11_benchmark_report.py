#!/usr/bin/env python3
"""Stable router for the V11 benchmark and V11.1.1 baseball shadow."""
from __future__ import annotations

import sys
import v11_benchmark_report_legacy as legacy

# Public helpers retained for the dedicated shadow module.
...
def main():
    if "--baseball-shadow" in sys.argv:
        import v11_baseball_shadow as shadow
        shadow.main()
