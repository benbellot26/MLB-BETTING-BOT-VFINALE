...
def _slice(rows:list[dict[str,Any]])->dict[str,Any]:
    ...
    certification=[_num(r.get("certification_clv_pp")) for r in canonical if r.get("close_quality")=="CERTIFIED_CLOSE" and r.get("certification_clv_benchmark")==PRIMARY_SHARP_BENCHMARK]; certification=[v for v in certification if v is not None]
